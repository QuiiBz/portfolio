    ...
    <Layout>
      <Col css={{ width: '100%', height: '100%' }} justify="between">
        ...
        <Row css={{ width: '100%' }} justify="between" align="end">
          <Col justify="center">
            <Typography>
              UI engineer living in{' '}
              <Hoverable
                color={{ from: '#E10101', to: '#FF7A7A' }}
                href="https://www.google.com/maps/place/Paris/@48.8588495,2.3120158,13z/data=!3m1!4b1!4m5!3m4!1s0x47e66e1f06e2b70f:0x40b82c3688c9460!8m2!3d48.856614!4d2.3522219"
                icon={<DrawingPinIcon />}
              >
                Paris
              </Hoverable>
            </Typography>
            <Typography css={{ marginTop: '8px' }}>
              Intern{' '}
              <Hoverable
                color={{ from: '#4F0599', to: '#8000FF' }}
